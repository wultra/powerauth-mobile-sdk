...
let package = Package(
    ...
    targets: [
        ...
        // --- PowerAuth2IntegrationTests ---

//        .testTarget(
//            name: "PowerAuth2IntegrationTests",
//            dependencies: [
//                "PowerAuth2",
//                "PowerAuth2TestsBase"
//            ],
//            path: "proj-xcode",
//            exclude: [
//                "PowerAuth2IntegrationTests/Info.plist"
//            ],
//            sources: [
//                "PowerAuth2IntegrationTests"
//            ],
//            resources: [
//                .copy("PowerAuth2IntegrationTests/TestConfig"),
//                .copy("PowerAuth2IntegrationTests/PowerAuthServer/RestEndpoints"),
//            ],
//            cSettings: [
//                .headerSearchPath("."),
//                .headerSearchPath("PowerAuth2IntegrationTests"),
//                .headerSearchPath("PowerAuth2IntegrationTests/PowerAuthServer"),
//            ]
//        ),
