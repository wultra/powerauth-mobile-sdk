...
1. First, upgrade all your applications to SDK `1.9.7` and implement safe `PowerAuthSDK` instantiation.
2. Wait until a significant portion of your users are using version `1.9.7` across all your applications.
