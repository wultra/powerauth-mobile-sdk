...
public class PowerAuthTestConfig {
    ...
    public static @NonNull PowerAuthTestConfig loadDefaultConfig() throws Exception {
        ...
        String serverAuthUser = getInstrumentationParameter("serverAuthUser", "");
        String serverAuthPass = getInstrumentationParameter("serverAuthPass", "");
        if (TextUtils.isEmpty(serverAuthUser)) {
            serverAuthUser = null;
        }
        if (TextUtils.isEmpty(serverAuthPass)) {
            serverAuthPass = null;
        }
