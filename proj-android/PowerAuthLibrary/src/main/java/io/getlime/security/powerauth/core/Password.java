...
/**
 The Password is an object representing an arbitrary passphrase. The underlying implementation
...
public class Password {
    ...
    /**
     Constructs a new instance of immutable Password object, initialized with UTF8 data
    ...
    /**
     Constructs a new instance of immutable Password object, initialized with the content
    ...
    /**
     Constructs a new instance of empty, mutable Password object.
     */
    public Password() {
    ...
    /**
     Returns true if Password object was created as mutable, or false if is immutable.
     */
    ...
    /**
     Returns true when this object and another password object contains equal passphrase.
     */
    ...
    /**
	 Clears internally stored passphrase. Returns false only if the object
