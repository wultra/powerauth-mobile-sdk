...
public class CreateActivationResult {
     ...
     */
    public CreateActivationResult(@NonNull String activationFingerprint, @Nullable Map<String, Object> customActivationAttributes) {
