...
NSInteger const PA2ErrorCodeTouchIDNotAvailable			= 9;  // deprecated, but must match PA2ErrorCodeBiometryNotAvailable
NSInteger const PA2ErrorCodeTouchIDCancel				= 10; // deprecated, but must match PA2ErrorCodeBiometryCancel
