...
/**
 The PA2Password is an object representing an arbitrary passphrase. The underlying implementation
 ...
 This is the simplest scenario, where you can simply create a PA2Password object with a final
 ...
 for a PIN keyboard and use the PA2MutablePassword object as the backing storage for 
 the passphrase.
 ...
 */
@interface PA2Password : NSObject

/**
 Returns a new instance of PA2Password object, initialized with UTF8 data
...
/**
 The PA2MutablePassword object is a mutable version of PA2Passphrase. You can edit 
 content of the passphrase
 
 The final passphrase is an UTF8 representation of added characters.
 */
@interface PA2MutablePassword : PA2Password
