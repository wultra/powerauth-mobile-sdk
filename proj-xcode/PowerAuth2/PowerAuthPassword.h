...
/**
 The `PowerAuthPassword` is an object representing an arbitrary passphrase. The underlying implementation
...
/**
 The method creates a new ``PowerAuthPassword`` immutable instance that will contain the same passphrase
 as the receiver.
 */
...
/**
 Initialize `PowerAuthMutablePassword` object with empty passphrase.
 */
