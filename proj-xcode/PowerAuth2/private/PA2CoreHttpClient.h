...
/// Set the next HTTP request with given relative path as failed with provided status code.
/// - Parameters:
///   - statusCode: Status code to report.
///   - relativePath: Relative path. If you use `"*"`, then any request will fail.
