...
/**
 The PowerAuthCorePass is an object representing an arbitrary password. The underlying implementation
 ...
 in the past where the system keyboard leaked the passwords, usually into the dynamic
 ...
 This is the simplest scenario, where you can simply create a `PowerAuthCorePass` object with a final
 ...
 for a PIN keyboard and use the `PowerAuthCoreMutablePass` object as the backing storage for
 the password.
...
/**
 Initialize `PowerAuthCorePass` object with UTF8 data from the given string. The method is useful
...
/**
 Initialize `PowerAuthCorePass` object with the content copied from given data object.
...
/**
 Returns a new instance of `PowerAuthCorePass` object, initialized with UTF8 data
...
/**
 Creates a new instance of `PowerAuthCorePass` object, initialized with the content
...
/**
 The method creates a new `PowerAuthCorePass` immutable instance that will contain the same password
 as the receiver.
 */
...
/**
 The `PowerAuthCoreMutablePass` object is a mutable version of `PowerAuthCorePass`. You can edit 
...
/**
 Initialize `PowerAuthCoreMutablePass` object with empty password.
 */
...
/**
 Returns a new instance of `PowerAuthCoreMutablePass` object.
 */
