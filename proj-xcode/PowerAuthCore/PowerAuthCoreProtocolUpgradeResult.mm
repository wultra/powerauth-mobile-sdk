...
#import "PowerAuthCoreProtocolUpgradeResult.h"
#import "PowerAuthCorePrivateImpl.h"

@implementation PowerAuthCoreProtocolUpgradeResult
...
- (instancetype) initWithProtocolUpgradeResult:(const powerAuth::ProtocolUpgradeResult&)protocolUpgradeResult
{
    ...
    if (self) {
        ...
        _activationFingerprint = cc7::objc::CopyToNullableNSString(protocolUpgradeResult.activationFingerprint());
    }
    return self;
}
