...
//    setup.legacyMasterServerPublicKey.readFromBase64String(cc7::objc::CopyFromNSString(publicKey));
...
//{
//    powerAuth::HTTPRequestDataSignature _signature;
//}
//
...
//{
//    powerAuth::SignedData _signedData;
//}
//
...
//{
//    powerAuth::ActivationStatus _status;
//}
//
//- (id) initWithStatusStruct:(const powerAuth::ActivationStatus&)statusStruct
//{
//    self = [super init];
//    if (self) {
...
//
//void PowerAuthCoreSignatureUnlockKeysToStruct(PowerAuthCoreSignatureUnlockKeys * keys, powerAuth::SignatureUnlockKeys & cpp_keys)
//{
...
//}
//
//void PowerAuthCoreHTTPRequestDataToStruct(PowerAuthCoreHTTPRequestData * req, powerAuth::HTTPRequestData & cpp_req)
//{
...
//}
//
//void PowerAuthCoreEncryptedActivationStatusToStruct(PowerAuthCoreEncryptedActivationStatus * status, powerAuth::EncryptedActivationStatus& cpp_status)
//{
...
//}
//
//PowerAuthCoreActivationStatus * PowerAuthCoreActivationStatusToObject(const powerAuth::ActivationStatus& cpp_status)
//{
//    return [[PowerAuthCoreActivationStatus alloc] initWithStatusStruct:cpp_status];
//}
//
//void PowerAuthCoreActivationStep1ParamToStruct(PowerAuthCoreActivationStep1Param * p1, powerAuth::ActivationStep1Param & cpp_p1)
//{
...
//}
//
//PowerAuthCoreActivationStep1Result * PowerAuthCoreActivationStep1ResultToObject(const powerAuth::ActivationStep1Result& cpp_r1)
//{
...
//}
//
//void PowerAuthCoreActivationStep2ParamToStruct(PowerAuthCoreActivationStep2Param * p2, powerAuth::ActivationStep2Param & cpp_p2)
//{
...
//}
//
//PowerAuthCoreActivationStep2Result * PowerAuthCoreActivationStep2ResultToObject(const powerAuth::ActivationStep2Result& cpp_r2)
//{
