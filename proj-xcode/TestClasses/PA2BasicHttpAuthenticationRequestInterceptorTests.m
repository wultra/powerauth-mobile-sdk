...
@interface PA2BasicHttpAuthenticationRequestInterceptorTests : XCTestCase
@end

@implementation PA2BasicHttpAuthenticationRequestInterceptorTests

- (void) testBasicAuthenticationRequestInterceptor
{
	PA2BasicHttpAuthenticationRequestInterceptor * basicAuth = [[PA2BasicHttpAuthenticationRequestInterceptor alloc] initWithUsername:@"Aladdin" password:@"OpenSesame"];
