 ...
 */
bool SerializePersistentData(const PersistentData & pd, cc7::utils::DataWriter & writer);
 ...
 */
bool DeserializePersistentData(PersistentData & pd, cc7::utils::DataReader & reader);
