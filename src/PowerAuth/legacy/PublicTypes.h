...
#include <PowerAuth/PowerAuthException.h>
...
struct SessionSetup
{
    ...
    /**
     P-384 ECDSA master server public key, X9.63 format.
     */
    cc7::ByteArray ecdsaMasterServerPublicKey;
    /**
     ML-DSA-65, master server public key, SPKI format.
     */
    cc7::ByteArray mldsaMasterServerPublicKey;
    /**
     P-256 legacy master server public key, X9.63 format.
     */
    cc7::ByteArray legacyMasterServerPublicKey;
...
typedef std::shared_ptr<SessionSetup> SessionSetupPtr;
