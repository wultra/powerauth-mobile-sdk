...
namespace powerAuthTests
{
    ...
    public:
        ...
        void test_EC_P384()
        {
            auto algorithm = SharedSecret::getInstance(EC_P384);
            for (int i = 0; i < 100; i++) {
        ...
        {
            auto algorithm = SharedSecret::getInstance(EC_P384_ML_L3);
            for (int i = 0; i < 2; i++) {
                auto req = algorithm->generateRequestCryptogram();
                auto client_request = req.first;
                auto client_ctx = req.second;
        ...
        void testVectors_EC_P384()
        {
            ...
            auto algorithm = SharedSecret::getInstance(EC_P384);
            JSONValue root = JSON_ParseFile(g_pa2Files, "pa2/ECDHE_P384_Test_Vectors.json");
        ...
        void testVectors_EC_P384_ML_L3()
        {
            // Original set from powerauth-crypto project
            auto algorithm = SharedSecret::getInstance(EC_P384_ML_L3);
            JSONValue root = JSON_ParseFile(g_pa2Files, "pa2/ECDHE_P384_MLKEM_768_Test_Vectors.json");
        ...
        void testVectors_EC_P384_ML_L3_Client()
        {
            ...
            auto algorithm = SharedSecret::getInstance(EC_P384_ML_L3);
            JSONValue root = JSON_ParseFile(g_pa2Files, "pa2/ECDHE_P384_MLKEM_768_Client_Vectors.json");
