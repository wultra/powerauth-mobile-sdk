...
public:
    ...
    void setUp() override
    {
        ...
        _setup.legacyMasterServerPublicKey.readFromBase64(_masterServerPrivateKey.public_key_str);
    ...
    void compareSetup(const SessionSetup * ss, const char * message)
    {
        ...
        ccstAssertEqual(ss->legacyMasterServerPublicKey,  _setup.legacyMasterServerPublicKey);
    }
    ...
    void testOldDataMigration()
    {
        ...
        oldSetup.legacyMasterServerPublicKey.readFromBase64(master_server_public_key);
    ...
    void testSkipRecoveryDataInV5()
    {
        ...
        setup.legacyMasterServerPublicKey.readFromBase64("AuCDGp3fAHL695yWxCP6d+jZEzwZleOdmCU+qFIImjBs");
